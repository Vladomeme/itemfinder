...
public class ClientController {
    ...
    public static void searchHandheld(MinecraftClient client, boolean global) {
        ...
        if (!player.isCreative()) {
            player.sendMessage(Text.of("Handheld search can only be started in creative."));
            return;
        }
        ...
        player.sendMessage(Text.literal("Requesting search for " + s).setStyle(Style.EMPTY.withColor(Formatting.YELLOW)));
